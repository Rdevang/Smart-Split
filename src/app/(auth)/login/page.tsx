...
const errorMessages: Record<string, string> = {
    ...
    email_exists:
        "An account with this email already exists. Please sign in with your original method (email/password).",
};
...
function LoginForm() {
    ...
    return (
        <div className="space-y-8">
            ...
            {/* Phone login - Disabled until Twilio is configured
            <Link
                href="/phone-login"
                className="flex h-12 w-full items-center justify-center gap-2 rounded-lg border-2 border-gray-200 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800"
            >
